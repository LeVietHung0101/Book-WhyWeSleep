...
## Tính phản trực giác của giấc ngủ

{: .note }
[Tiến sĩ Allan Rechtchaffen](https://news.uchicago.edu/story/allan-rechtschaffen-sleep-research-pioneer-1927-2021) đã nói: *"Nếu giấc ngủ không phục vụ một chức năng vô cùng quan trọng, thì nó chính là sai lầm lớn nhất mà quá trình tiến hoá từng tạo ra."*

Từ góc nhìn tiến hoá, giấc ngủ có vẻ là một "bất lợi" rõ ràng:
- Khi ngủ, chúng ta không thể ăn uống → giảm cơ hội sống sót.
- Không thể giao tiếp xã hội → giảm khả năng xây dựng quan hệ.
- Không thể tìm bạn đời và sinh sản.
- Dễ bị tấn công bởi kẻ săn mồi (đặc biệt trong môi trường hoang dã).
...
<table class="hover-table">
  ...
  <tbody>
    <tr>
      <td>Não bộ → cải thiện trí nhớ, tư duy<br>Tim mạch → ổn định huyết áp<br>Nội tiết → cân bằng hormone<br>Miễn dịch → tăng khả năng chống bệnh</td>
      <td>Giảm tập trung, trí nhớ kém<br>Tăng nguy cơ bệnh tim, tiểu đường<br>Rối loạn cảm xúc, stress, lo âu</td>
    </tr>
  </tbody>
</table>

{: .note }
Giấc ngủ là hoạt động đơn lẻ có hiệu quả nhất mà chúng ta có thể thực hiện để lấy lại sức khoẻ cho cơ thể và trí não mỗi ngày.