...
- Lược bớt ký ức không cần thiết để dành chỗ cho ký ức mới (ví dụ: quên chỗ đậu xe cũ để nhớ chỗ mới). 
- Loại bỏ ký ức đau đớn hoặc dập tắt cơn thèm trong các rối loạn gây nghiện. 
- Giảm bớt tài nguyên não khi truy xuất ký ức quan trọng (tương tự như bàn làm việc gọn gàng). 

---

## Ghi nhớ có chọn lọc khi ngủ 
...
Giấc ngủ không xử lý ký ức một cách đồng đều, mà ưu tiên lưu trữ ký ức quan trọng (20-40% so với thức, dựa vào thí nghiệm trên) và loại bỏ ký úc không cần thiết. Sự lựa chọn ký ức dựa vào giấc ngủ này xuất hiện ở cả các giấc ngủ ngắn ban ngày và một giấc ngủ đêm trọn vẹn. 

---

## Cơ chế chọn lọc ký ức trong giấc ngủ
